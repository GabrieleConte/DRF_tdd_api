...
class PublicAPIRecipeTests(TestCase):
    """Test unauthenticated Recipes endpoints"""

    def setUp(self):
        self.client = APIClient()

    def test_auth_required(self):
        """Test auth os required to call API"""
...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        """Test if recipe is limited to authenticated user"""
    ...
    def test_partial_update(self):
        """Test partial Patch on a recipe"""
    ...
    def test_perform_full_update(self):
        ...
        payload = {
            "title": "new recipe title",
            "link": "https://example.com/newrecupe.pdf",
            "description": "new recipe desc",
            "time_minutes": 55,
            "price": Decimal("6.32"),
        }
        url = detail_url(recipe.id)
    ...
    def test_recipe_other_users_recipe_error(self):
        """Try to delete another user recipe gives error"""
        new_user = create_user(
            email="user2@example.com",
            password="testpass123"
        )
    ...
    def test_update_recipe_assign_ingredient(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        recipe.refresh_from_db()
        # not necessary for many to many fields
